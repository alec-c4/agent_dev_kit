...
Universal developer kit for AI-assisted product engineering. **LLM-agnostic** and **stack-agnostic** — works with Cursor, Claude Code, Copilot, Windsurf, and others.
...
| Tool | Adapter |
|------|---------|
| Cursor, Copilot, Windsurf, etc. | `AGENTS.md` + optional `kit-*.mdc` rules |
